...
class Accommodation extends Model {
  ...
  AccommodationModelIdentifier get modelIdentifier {
      return AccommodationModelIdentifier(
        id: id
      );
  }
  ...
  const Accommodation._internal({required this.id, required name, steps, createdAt, updatedAt}): _name = name, _steps = steps, _createdAt = createdAt, _updatedAt = updatedAt;
  ...
  Accommodation copyWith({String? name, List<Step>? steps}) {
    return Accommodation._internal(
      id: id,
      name: name ?? this.name,
...
class _AccommodationModelType extends ModelType<Accommodation> {
  ...
  @override
  Accommodation fromJson(Map<String, dynamic> jsonData) {
    return Accommodation.fromJson(jsonData);
  }
...
class AccommodationModelIdentifier implements ModelIdentifier<Accommodation> {
  ...
  const AccommodationModelIdentifier({
    required this.id});
  ...
  @override
  String toString() => 'AccommodationModelIdentifier(id: $id)';
  ...
  bool operator ==(Object other) {
    ...
    return other is AccommodationModelIdentifier &&
      id == other.id;
  }
