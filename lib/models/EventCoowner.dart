...
class EventCoowner extends amplify_core.Model {
  ...
  EventCoowner copyWithModelFieldValues({
  ...
  static final amplify_core.QueryModelIdentifier<EventCoownerModelIdentifier> MODEL_IDENTIFIER = amplify_core.QueryModelIdentifier<EventCoownerModelIdentifier>();
...
class _EventCoownerModelType extends amplify_core.ModelType<EventCoowner> {
 ...
 */
class EventCoownerModelIdentifier implements amplify_core.ModelIdentifier<EventCoowner> {
  final String id;
