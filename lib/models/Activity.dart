...
class Activity extends Model {
  ...
  const Activity._internal({required this.id, required activity, steps, createdAt, updatedAt}): _activity = activity, _steps = steps, _createdAt = createdAt, _updatedAt = updatedAt;
  ...
  Activity copyWith({String? activity, List<StepActivities>? steps}) {
    return Activity._internal(
      id: id,
