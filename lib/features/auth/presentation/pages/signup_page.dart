      ...
      body: BlocBuilder<SignupBloc, SignupState>(
        builder: (context, state) {
          if (state is SignupInitialState) {
            ...
            return passwordScreen(context, emailController, passwordController,
                confirmPasswordController);
          } else if (state is SignupConfirmCodeState) {
            return confirmCodeScreen(
                context, confirmCodeController, confirmCodeController);
          } else {
            return Container();
          }
        },
...
// Screens
Widget emailScreen(BuildContext context, TextEditingController emailController) {
  return Center(
    child: Padding(
      ...
      child: Column(
        children: [
          ...
          signupTextField(context, emailController, "email"),
          const SizedBox(
            height: 80,
          ),
          const Text(
    ...
    child: Padding(
      ...
      child: Column(
        children: [
          ...
          signupTextField(context, passwordController, "password"),
          const SizedBox(
            height: 35,
          ),
          signupTextField(
          ...
          ElevatedButton(
              style: primaryButton,
              onPressed: () {
                BlocProvider.of<SignupBloc>(context).add(ValidatePasswordButtonPressed(
      ...
      child: Column(
        children: [
          ...
          ElevatedButton(
              style: primaryButton,
              onPressed: () {
                BlocProvider.of<SignupBloc>(context).add(ValidateConfirmCodeButtonPressed(
                    email: emailController.text,
